            ...
            <div>
                ...
                <div>
                    <div>
                        ...
                        <input className={this.state.ok.inn === false ? 'wrong-phone' : ''}
                            type="text"
                            name="inn"
                            id="inn"
                    ...
                    <div>
                        ...
                        <input className={this.state.ok.bik === false ? 'wrong-phone' : ''}
                            type="text"
                            name="bik"
                            id="bik"
                    ...
                    <div>
                        ...
                        <input className={this.state.ok.account_number === false ? 'wrong-phone' : ''}
                            type="text"
                            name="account_number"
                            id="account_number"
                    ...
                    <div>
                        ...
                        <input className={this.state.ok.for_what === false ? 'wrong-phone' : ''}
                            type="text"
                            id="for_what"
                            name="for_what"
                    ...
                    <div>
                        ...
                        <input className={this.state.ok.amount === false ? 'wrong-phone' : ''}
                            type="text"
                            name="amount"
                            id="amount"
                    ...
                    <div>
                        ...
                        <input className={this.state.ok.phone === false ? 'wrong-phone' : ''}
                            type="tel"
                            name="phone"
                            id="phone"
                    ...
                    <div>
                        ...
                        <input className={this.state.ok.email === false ? 'wrong-phone' : ''}
                            type="email"
                            name="email"
                            id="email"
